...
```{r}
ggplot(heights) + geom_histogram(aes(x = height), binwidth = 1)
ggplot(heights) + geom_histogram(aes(x = height), binwidth = 5)
ggplot(heights) + geom_histogram(aes(x = height), binwidth = 10)
ggplot(heights) + geom_histogram(aes(x = height), binwidth = 20)
...
```{r}
ggplot(heights) + 
  geom_density(aes(x = height, group = sex))
...
```{r}
ggplot(heights) + 
  geom_density(aes(x = height, group = sex, fill = sex, color = sex))
...
```{r}
ggplot(heights) + 
  geom_density(aes(x = height, group = sex, fill = sex, color = sex), alpha = .5)
...
```{r}
ggplot(heights) + 
  geom_boxplot(aes(x = height, group = sex, fill = sex, color = sex), alpha = .5)
```
...
```{R}
heights %>% filter( sex == "Female") %>%  summarise(tall_female = max(height))
heights %>% filter( sex == "Male") %>%  summarise(short_male = min(height))
```
